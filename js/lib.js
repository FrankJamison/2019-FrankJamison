...
jQuery(document).ready(function() {
    ...
    jQuery('#profile:not(.printable) .profile_section_header h1').click(function() {
        if (jQuery(this).find('.section_name').hasClass('show')) {
            jQuery(this).find('.section_name').animate({
                    'width': '135',
                    'opacity': '1'
                },
    ...
    jQuery('#mainpage_accordion_area h1.section_title').click(function() {
    ...
    jQuery('#theme_switcher').click(function(e) {
        ...
        jQuery.cookie('theme_style', theme_style, {
            expires: 365,
            path: '/'
        });
        e.preventDefault();
